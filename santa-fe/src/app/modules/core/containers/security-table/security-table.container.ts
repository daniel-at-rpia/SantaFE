...
export class SecurityTable {
  ...
  public onClickRowTableCanvas(targetRow: SecurityTableRowDTO) {
    ...
    msg2.data.broker = 'DB';
    const msg3 = this.dtoService.formSecurityTradingMessageObject(false, true, false, 'T 0.5 01/01/2020', 'T 0.5 01/01/2020');
    msg3.data.bid.isAxe = true;
    msg3.data.dataSource = 'MSG';
    msg3.data.broker = 'BARC';
    const msg4 = this.dtoService.formSecurityTradingMessageObject(false, true, false, 'T 0.5 01/01/2020', 'T 0.5 01/01/2020');
    msg4.data.ask.isAxe = false;
    msg4.data.broker = 'BARC';
    const msg5 = this.dtoService.formSecurityTradingMessageObject(false, false, true, 'T 0.5 01/01/2020', 'T 0.5 01/01/2020');
    msg5.data.ask.isAxe = false;
    msg5.data.broker = 'USBC';
    const msg6 = this.dtoService.formSecurityTradingMessageObject(false, true, true, 'T 0.5 01/01/2020', 'T 0.8 01/01/2025');
