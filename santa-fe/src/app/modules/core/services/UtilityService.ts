...
export class UtilityService {
  ...
  // trade specific
    ...
    public generateCustomizedTitleForShortcut(targetShortcut: DTOs.SearchShortcutDTO): string {
      ...
      if (targetShortcut.data.searchFilters[0].length === 1 && targetShortcut.data.searchFilters[0][0].data.key === globalConstants.definition.SecurityDefinitionMap.QUOTED_TODAY.key) {
        customDisplayTitle = globalConstants.definition.SecurityDefinitionMap.QUOTED_TODAY.displayName;
      } else {
